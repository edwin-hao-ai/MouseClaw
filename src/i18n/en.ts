...
export const en: Strings = {
  ...
  "tutorial.title": "Pick one and say it to the mouse — it'll show you live",
  "tutorial.lead": "Three classic uses. Hit \"Try this\" and it runs for real — no need to actually speak.",
  "tutorial.cardA.title": "Browser automation",
  "tutorial.cardA.line": "\"Search today's weather in Beijing\"",
  "tutorial.cardA.outcome": "→ Mouse opens browser · searches · reads result",
  "tutorial.cardB.title": "Read / write Office files",
  "tutorial.cardB.line": "\"Summarize this spreadsheet\" (sample xlsx)",
  "tutorial.cardB.outcome": "→ officecli reads · 3-line summary",
  "tutorial.cardC.title": "Write at cursor (Mode B)",
  "tutorial.cardC.line": "\"Write a one-liner product pitch\"",
  "tutorial.cardC.outcome": "→ 3s countdown · auto-types at cursor",
  "tutorial.try_this": "Try this",
  "tutorial.skip": "Skip · start using",
  "tutorial.done": "Done · start using MouseClaw",
  "onbinst.title": "Give the mouse its hands",
  "onbinst.lead": "Two open-source CLIs that let the mouse actually drive a browser and edit Office files. ~30–60 seconds.",
  "onbinst.show_cmd": "Show the exact commands to run",
  "onbinst.go": "Install both →",
  "onbinst.skip": "Skip · install later on the status page",
  "onbinst.continue": "Continue →",
  "onbinst.installing": "Installing…",

...
export const en: Strings = {
  ...
  // v0.5.x · settings window
  "set.cat.summon": "Summon & AI", "set.cat.voice": "Voice input", "set.cat.pet": "Pet",
  "set.cat.sound": "Sound", "set.cat.general": "General", "set.cat.privacy": "Privacy & Data", "set.cat.diag": "Diagnostics",
  "set.shortcut": "Summon shortcut", "set.shortcut.hint": "Hold to record, release to send; empty / type button → text input.",
  "set.backend": "AI backend", "set.backend.hint": "Screenshot + prompt go to it. Switching won't affect local voice.",
  "set.vime": "Voice input (dictation)", "set.vime.hint": "Hold the trigger to talk, release types it at the cursor (local, no AI).",
  "set.trigger": "Trigger key", "set.trigger.hint": "Hold this key to start talking.",
  "set.vocab": "Built-in term vocabulary", "set.vocab.hint": "Restores casing: OPENAI→OpenAI, USEEFFECT→useEffect.",
  ...
  "set.tidy": "Organize dictation into a list",
  "set.tidy.hint": "Turns a long 'first… then… also…' ramble into a numbered 1. 2. 3. list. Pure rules, instant, zero model (off by default).",
  ...
  "set.persona": "Personality", "set.persona.hint": "Affects reply tone.",
  "set.tts": "Read AI replies (TTS)", "set.tts.hint": "Speak replies via system say. Off by default.",
  "set.sfx": "Pet sound effects", "set.sfx.hint": "Squeaks / typing / hop — synthesized (voice changes per skin).", "set.sfx.vol": "SFX volume",
  "set.lang": "Interface language", "set.lang.hint": "Language for menus / bubbles / settings.",
  "set.autostart": "Launch at login", "set.autostart.hint": "Start in the background at login (no window, menubar only).",
  "set.workspace": "Working directory", "set.workspace.hint": "Default root where AI runs commands / reads files.", "set.workspace.btn": "Choose folder…",
  "set.privacy.desc": "All local, pausable anytime. MouseClaw never uploads your content.",
  "set.clip": "Clipboard awareness", "set.clip.hint": "Pet reacts when you copy. Off = never reads clipboard.",
  "set.memory": "Long-term memory", "set.memory.hint": "Distills chats into a profile so the pet remembers you. Off = no logging.",
  "set.memory.manage": "Manage memory", "set.memory.manage.hint": "View / delete what the pet remembers.", "set.memory.manage.btn": "Open memory…",
  "set.diag.desc": "Capability & permission status. Red = not installed / not granted, click to fix.",
};

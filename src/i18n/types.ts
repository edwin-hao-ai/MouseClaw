...
export interface Strings {
  ...
  "tutorial.lead": string;
  "tutorial.cardA.title": string;
  "tutorial.cardA.line": string;
  "tutorial.cardA.outcome": string;
  "tutorial.cardB.title": string;
  "tutorial.cardB.line": string;
  "tutorial.cardB.outcome": string;
  "tutorial.cardC.title": string;
  "tutorial.cardC.line": string;
  "tutorial.cardC.outcome": string;
  "tutorial.try_this": string;
  "tutorial.skip": string;
  "tutorial.done": string;

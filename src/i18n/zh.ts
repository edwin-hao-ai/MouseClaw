...
export const zh: Strings = {
  ...
  "tutorial.title": "挑一条对老鼠喊出来 · 它现场演给你看",
  "tutorial.lead": "三种典型用法，按「试这条」会自动跑给你看 —— 不用真的喊。",
  "tutorial.cardA.title": "浏览器自动化",
  "tutorial.cardA.line": "「搜一下今天北京天气」",
  "tutorial.cardA.outcome": "→ 老鼠开浏览器 · 搜 · 念结果给你",
  "tutorial.cardB.title": "读写 Office 文件",
  "tutorial.cardB.line": "「总结这个表」（用示例 xlsx）",
  "tutorial.cardB.outcome": "→ officecli 读表 · 3 句摘要",
  "tutorial.cardC.title": "写回光标（B 模式）",
  "tutorial.cardC.line": "「写一句产品介绍」",
  "tutorial.cardC.outcome": "→ 倒数 3s · 自动键入光标位置",
  "tutorial.try_this": "试这条",
  "tutorial.skip": "跳过 · 开始用",
  "tutorial.done": "完成 · 开始用 MouseClaw",
  "onbinst.title": "给老鼠装上动手能力",
  "onbinst.lead": "两个开源 CLI，让老鼠真能操作浏览器和 Office 文件。约 30–60 秒。",
  "onbinst.show_cmd": "显示要执行的完整命令",
  "onbinst.go": "装好这两个 →",
  "onbinst.skip": "跳过 · 之后在状态页装",
  "onbinst.continue": "继续 · 下一步",
  "onbinst.installing": "安装中…",
